...
@Component
public class CustomTestContextListener implements TestExecutionListener {
    ...
    public void prepareTestInstance(TestContext testContext) {
        if (RequestContext.getRequestContextDetails() == null) {
            ConfigLoader.loadConfigurations(testContext.getApplicationContext().getEnvironment());
            logger.info("CustomTestContextListener: Initializing Test Context - prepareinstance");
        }
    }
    ...
    public void beforeTestClass(TestContext testContext) {
        if (RequestContext.getRequestContextDetails() == null) {
            ConfigLoader.loadConfigurations(testContext.getApplicationContext().getEnvironment());
            logger.info("CustomTestContextListener: Initializing Test Context - beforeClassTest");
        }
    }
}
