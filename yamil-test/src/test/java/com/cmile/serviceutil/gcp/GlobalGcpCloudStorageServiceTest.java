...
public class GlobalGcpCloudStorageServiceTest extends AbstractCommonTest {
    private static final Logger logger = LoggerFactory.getLogger(GlobalGcpCloudStorageServiceTest.class);
    ...
    void testUploadFile_File() throws IOException {
        ...
        gcpCloudStorageService.createBucketIfNeeded(BUCKET_NAME, "us-east4");
        GCPCloudStoragePath path = gcpCloudStorageService.uploadFile(dummyFile, BUCKET_NAME);
        assertNotNull(path);
    ...
    void testUploadFile_String() throws IOException {
        gcpCloudStorageService.createBucketIfNeeded(BUCKET_NAME, "us-east4");
        GCPCloudStoragePath path = gcpCloudStorageService.uploadFile(TEST_FILE_PATH,
                TEST_FILE_CONTENT, BUCKET_NAME);
        assertNotNull(path);
    }
    ...
    void testGetSignedUrl() {
        ...
        BlobId blobId = BlobId.of(BUCKET_NAME, TEST_SIGNED_FILE_PATH);
        ...
        URL signedUrl = gcpCloudStorageService.getSignedUrl(BUCKET_NAME, StoragePathEnum.CONTAINER_UPLOAD, TEST_SIGNED_FILE_PATH, CONTENT_TYPE);
    ...
    void testMoveFile() throws IOException {
        gcpCloudStorageService.createBucketIfNeeded(BUCKET_NAME, "us-east4");
        gcpCloudStorageService.uploadFile(ORIGINAL_FILE_PATH, TEST_FILE_CONTENT, BUCKET_NAME);
        String newObjectId = gcpCloudStorageService.moveFile(BUCKET_NAME,
                ORIGINAL_FILE_PATH, StoragePathEnum.CONTAINER_UPLOAD, StoragePathEnum.CONTAINER_INPROGRESS);
    ...
    void testReadFile() throws IOException {
        gcpCloudStorageService.createBucketIfNeeded(BUCKET_NAME, "us-east4");
        gcpCloudStorageService.uploadFile(TEST_READ_FILE_PATH, TEST_FILE_CONTENT, BUCKET_NAME);
        String fileContents = gcpCloudStorageService.readFile(BUCKET_NAME, TEST_READ_FILE_PATH);
