...
@Configuration
@ComponentScan(value = "com.cmile.serviceutil.bigquery")
@Import({ CfgGCPProject.class, CfgSecret.class, GCPServiceProject.class })
public class CfgBigQuery {

    private final GoogleCredentials credentials;

    public CfgBigQuery(GCPServiceProject gcpServiceProject) {
